...
private:
    ...
    struct WindroseR5UiScanState {
        ...
        bool sweep_saw_negative_space_controller{false};
        bool sweep_saw_negative_space_widget{false};
        bool sweep_saw_modal{false};
        bool sweep_saw_scene_blackout{false};
        bool sweep_saw_fullscreen_meta{false};
        int32_t sweep_modal_hits{0};
        int32_t sweep_scene_blackout_hits{0};
        int32_t sweep_fullscreen_meta_hits{0};
        uintptr_t sweep_negative_space_controller{};
        uintptr_t sweep_negative_space_widget{};
        std::string sweep_sample{};
        std::string sweep_meta_menu_controller_sample{};
        std::string sweep_negative_space_sample{};
        std::string sweep_fullscreen_meta_sample{};
        ...
        bool last_saw_negative_space_controller{false};
        bool last_saw_negative_space_widget{false};
        bool last_saw_fullscreen_meta{false};
        int32_t last_modal_hits{0};
        int32_t last_scene_blackout_hits{0};
        int32_t last_fullscreen_meta_hits{0};
        std::string last_sample{};
        std::string last_meta_menu_controller_sample{};
        std::string last_negative_space_sample{};
        std::string last_fullscreen_meta_sample{};
        std::string last_scene_blackout_sample{};
        int32_t negative_space_active_confirm_frames{0};
        int32_t negative_space_inactive_confirm_frames{0};
        uintptr_t forced_negative_space_controller{};
        uintptr_t forced_negative_space_widget{};
