...
RenderAnalysisExportResult RenderAnalysisExport::export_bundle(const RenderAnalysisExportInput& input) {
    ...
    try {
        ...
        json dx12_json{
            ...
            {"framegen_kind", input.d3d12.framegen_kind},
            {"framegen_wrapper_swapchain", format_pointer(input.d3d12.framegen_wrapper_swapchain)},
            {"framegen_internal_swapchain", format_pointer(input.d3d12.framegen_internal_swapchain)},
            {"framegen_internal_swapchain_offset", input.d3d12.framegen_internal_swapchain_offset},
            {"streamline_module_loaded", input.d3d12.streamline_module_loaded},
            {"streamline_link_hooked", input.d3d12.streamline_link_hooked},
